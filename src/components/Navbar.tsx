    ...
    <>
      <nav className="navbar" role="navigation" aria-label="Navigation principale">
        ...
        <ul className={`navbar-menu ${isMenuOpen ? 'open' : ''}`} role="menu">
          ...
          <li role="menuitem"><Link to="/profile" onClick={() => setIsMenuOpen(false)}>Mon compte</Link></li>
          <li role="menuitem"><Link to="/investigations" onClick={() => setIsMenuOpen(false)}>Enquêtes</Link></li>
