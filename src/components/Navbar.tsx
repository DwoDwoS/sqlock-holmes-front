    ...
    <>
      <nav className="navbar" role="navigation" aria-label="Navigation principale">
        ...
        <ul className={`navbar-menu ${isMenuOpen ? 'open' : ''}`} role="menu">
          <li role="menuitem"><Link to="/" className={isActive('/') ? 'active' : ''} onClick={() => setIsMenuOpen(false)}>Accueil</Link></li>
          <li role="menuitem"><Link to="/profile" className={isActive('/profile') ? 'active' : ''} onClick={() => setIsMenuOpen(false)}>Mon compte</Link></li>
          <li role="menuitem"><Link to="/investigations" className={isActive('/investigations') ? 'active' : ''} onClick={() => setIsMenuOpen(false)}>Enquêtes</Link></li>
